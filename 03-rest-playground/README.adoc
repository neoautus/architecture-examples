...
Afterwards, you can use just `ant` to rebuild changed modules. That will avoid redeploying all Jersey bundles, which are already deployed after the initial `ant build-all`.
